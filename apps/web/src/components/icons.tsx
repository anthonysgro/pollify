...
export const Icons = {
    ...
    completeEditor: (props: IconProps) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
            fill="none"
    ...
    guage: (props: IconProps) => (
        <svg
            ...
            fill="none"
            stroke="currentColor"
            className="lucide lucide-guage mr-2 h-4 w-4"
            {...props}
        >
            <path d="m12 14 4-4" />
